...
截至 2026-09-01，完整单元测试基线曾运行到 120 个测试，其中有 7 个失败和 1 个错误，主要集中在草稿审阅/澄清暂停状态。该问题仍在修正中，因此本 README 不宣称当前完整测试套件已经全部通过。无 API Key 的脚本演示可用于展示基本的证据驱动修复流程。

.env、run.jsonl、虚拟环境和缓存文件已被 .gitignore 排除，不应提交。课程相关的依据与演示材料见：

- [文献依据](docs/literature_basis.md)
- [评测口径](docs/evaluation_harness.md)
- [视频演示脚本](docs/video_script.md)
